...
const Settings = ({onUpdateModel, currentModelSize, availableMemory, transcriptionModels, onUpdateLanguage, currentLanguage, onUpdateTranscribeAndShutdown, currentTranscribeAndShutdown}) => {
